<template>
  <div class="song">
    ...
    <div class="big-player" v-show="this.isPlaystatus">
      ...
      <div class="min-player"  v-if="!this.isPlaystatus" v-show="isPlayShow">
        <div class="min-play-box" @click="changeStateOfPlayer">
            <div class="min-play-img">
              <img :src="songUrl" alt="" class="auto-img" />
            </div>
            <div class="min-play-name">
              <div class="min-play-title van-ellipsis">{{musicDate.name}} - {{singerName}}<span v-if="musicDate.name == 0">电台</span></div>
