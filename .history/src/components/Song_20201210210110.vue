      ...
      <div class="min-player"  v-if="!this.isPlaystatus">
        <div class="min-play-box" @click="changeStateOfPlayer">
            ...
            <div class="min-play-name">
              <div class="min-play-title van-ellipsis"><span v-if="isPlayUrl">{{musicDate.name}} - {{singerName}}</span><span v-if="musicDate.name == 0">电台</span><span v-if="!isPlayUrl">当前未播放歌曲</span></div>
