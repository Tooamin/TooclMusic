<template>
  <div class="banner-box">
    ...
    <div class="functional-area">
        <div class="area-box">
            <div class="area-item" v-for="(item,index) in functionalAreaData" :key="index"><img :src="item.Img" alt=""><div class="item-title" @click="gotoggle(item.jumpid)">{{item.title}}</div></div>
        </div>
    </div>
