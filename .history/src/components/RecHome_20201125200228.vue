<template>
  <div class="rechome">
    ...
    <div class="functional-area">
        <div class="area-box">
            <div class="area-item" v-for="(item,index) in functionalAreaData" :key="index"><img src="../assets/images/MV.png" alt=""><div class="item-title">歌单</div></div>
        </div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      functionalAreaData:[
          ...
          {
              title:'排行榜',
              Img:require("../assets/images/ziyuan.png")
          },
          {
              title:'MV',
