<template>
  <div class="song">
    <van-sticky>
    <div class="big-player" v-if="this.isPlaystatus">
        <div
          class="songbg"
      ...
      <div class="min-player"  v-if="!this.isPlaystatus" v-show="isPlayShow">
        <div class="min-play-box" @click="changeStateOfPlayer">
            ...
            <div class="min-play-name">
              <div class="min-play-title van-ellipsis"><span v-if="musicDate.name.length > 0">{{musicDate.name}} - {{singerName}}</span></div>
