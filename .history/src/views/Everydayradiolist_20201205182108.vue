  ...
  <div class="everydayradiolist">
    ...
    <div class="everydaylist-box">
      <div class="everydaylist-item" v-for="(item,index) in everydaylistAllData" :key="index">
        <div class="everydaylist-number">{{index >= 9  ? (index+1) : '0'+(index+1)}}</div>
        <div class="everydaylist-img"><img :src="item.program.coverUrl" alt="" class="auto-img" /></div>
        <div class="everydaylist-name">
          <div class="everydaylist-title">{{item.propgram.name}}</div>
