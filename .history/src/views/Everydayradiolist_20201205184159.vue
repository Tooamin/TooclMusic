<template>
  <div class="everydayradiolist">
    ...
    <div class="everydaylist-box">
      <div class="everydaylist-item" v-for="(item,index) in everydaylistAllData" :key="index" @click="clickMusicGetid(item.program.mainSong.id)">
        ...
        <div class="everydaylist-name">
          ...
          <div class="everydaylist-subtitle">
              <div class="userinfo">
                  <div class="userinfo-img"><img :src="item.program.dj.avatarUrl" alt="" class="auto-img"></div>
