...
export default {
  ...
  methods: {
    ...
    getNewsonglistData() {
      ...
      this.axios({
        ...
        .then((result) => {
          ...
          this.currentsonglistData = this.songlistData.slice(this.startIndex, this.startIndex+this.currentIndex);
    ...
    loadData(){
      setTimeout( ()=>{
        let data = this.songlistData.slice(this.startIndex, this.startIndex+this.currentIndex);

        this.startIndex += this.currentIndex;

        currentsonglistData.push(...data);
