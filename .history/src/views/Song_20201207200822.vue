<template>
  <div class="song">
    <div class="songbg" :style="{ backgroundImage: 'url(' + songUrl + ')' }"></div>
      ...
      <div class="progressbar">
        ...
        <div class="play-conponents">
          <div class="model"><img src="../assets/images/suijiplay-01.png" alt="" class="auto-img"></div>
          <div class="upsong"><img src="../assets/images/upsong.png" alt="" class="auto-img"></div>
          <div class="plyasong"><img src="../assets/images/play.png" alt="" class="auto-img"></div>
          <div class="nextsong"><img src="../assets/images/nextsong.png" alt="" class="auto-img"></div>
          <div class="directory"><img src="../assets/images/list.png" alt="" class="auto-img"></div>
        </div>
      </div>
    </div>
  </div>
