...
export default {
  ...
  methods: {
    ...
    updateCurrent(){
      this.currentBar == 100 ? (this.clearTimer(),this.loopStyle == "not" ? this.notLoop() : this.loopStyle == "list" ? this.listLoop() : this.loopStyle == "single" ? this.singleLoop() : this.randomLoop()) : (this.currentBar = this.$refs.audio.currentTime / this.$refs.audio.duration)
    }
  },
  computed: {
    //当前播放信息
