    ...
    <div class="popup">
      ...
      >
        <div class="popup-content">
          <div class="popup-title">当前播放</div>
          <div
            class="songlist-item"
...
export default {
  ...
  created() {
    ...
    //获取音乐详情
    this.getMusicDeateil(this.musicid);
    //清除定时器
    this.clearTimer();
  },
  methods: {
      ...
      this.axios({
        ...
        .then((result) => {
          ...
          if (result.data.code == 200) {
            ...
            this.$store.commit("getSongCount",this.musicDate);
          }
        })
        .catch((err) => {
           (err);
    ...
    prevSong(){
      ...
      this.$store.commit("getSongCount",this.playList)
    }
  },
  computed: {
    //当前播放信息
