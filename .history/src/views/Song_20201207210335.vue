      ...
      <div class="progressbar">
        <div class="range-box">
          ...
          <div class="range">
            ...
            <audio :ref="musicid.url" autoplay></audio>
          </div>
          <div class="endtiem">00:00</div>
        </div>
        <div class="play-conponents">
          <div class="model"><img src="../assets/images/suijiplay-01.png" alt="" ></div>
          <div class="upsong"><img src="../assets/images/upsong.png" alt="" ></div>
          <div class="plyasong"><img src="../assets/images/play.png" alt="" ></div>
          <div class="nextsong"><img src="../assets/images/nextsong.png" alt="" ></div>
          <div class="directory"><img src="../assets/images/list.png" alt=""></div>
        </div>
      </div>
    </div>
</template>
