    ...
    <div class="userinfo-box">
      ...
      <div class="createplaylist">
          ...
          <div class="ceateplaylist-box">
              <Likemusicitem v-for="(item,index) in createplaylistData" :key="index" :like-img="item.coverImgUrl" :like-title="item.name" :like-number="item.trackCount" @go-toggle="gojump('SonglistDateil', item.id)" ></Likemusicitem>
          </div>
      </div>
      <div class="my-collection">
        <div class="createplaylist-title">收藏的歌单</div>
          <div class="ceateplaylist-box">
              <Likemusicitem v-for="(item,index) in createplaylistData" :key="index" :like-img="item.coverImgUrl" :like-title="item.name" :like-number="item.trackCount" ></Likemusicitem>
          </div>
      </div>
    </div>
  </div>
