      ...
      this.axios({
        ...
        .then((result) => {
          ...
          for(let i = 1 ; i < result.data.playlist.length;i++){
               (result.data.playlist[i]);
              if(result.data.playlist[i].creator.nickname == "瞳瞳瞳瞳瞳子"){
                  this.createplaylistData = result.data.playlist[i];
              }else{
                  this.collectionplaylistData = result.data.playlist[i];
              }
          }
