  ...
  <div class="song">
    ...
    <div class="progressbar">
      ...
      <div class="play-conponents">
        <div class="model">
          <img src="../assets/images/suijiplay.png" alt="" v-if="loopStyle == 'lisr'" />
          <img src="../assets/images/shunxuplay.png" alt="" v-if="loopStyle != 'lisr'"  />
        </div>
        <div class="upsong">
          <img src="../assets/images/upplay.png" alt="" />
        </div>
        <div class="plyasong" @click="play">
          <img src="../assets/images/play.png" alt="" v-if="playStatus" @click="play" />
          <img src="../assets/images/end.png" alt="" v-if="!playStatus" @click="pause" />
        </div>
        <div class="nextsong">
