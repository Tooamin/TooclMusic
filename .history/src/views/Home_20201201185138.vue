      ...
      <Newmusicblock :left-title="'新歌推荐'">
        <div class="anewsong-box">
          <div class="anewsong-item">
            <div class="anewsong-img">
              <img src="http://p1.music.126.net/OJAy7jZpHi-Y3ql50PTD4g==/109951164670422227.jpg" alt="">
            </div>
            <div class="anewsong-name">
              <div class="anewsong-title"></div>
              <div class="anewsong-subtitle"></div>
            </div>
            <div class="anewsong-icon"></div>
          </div>
        </div>
      </Newmusicblock>
    </div>
