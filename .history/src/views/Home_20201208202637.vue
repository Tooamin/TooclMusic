<template>
  <div class="home">
    ...
    <div class="anewsong">
      <Newmusicblock :left-title="'新歌推荐'" @go-view="goRadom('Newsonglist')">
        <div class="anewsong-box">
          <div class="anewsong-item" v-for="(item,index) in newSongData" :key="index" @click="clickMusicGetid(item)">
...
export default {
  ...
  methods: {
    ...
    clickMusicGetid(item) {
      ...
      this.$store.commit("getplayList",item.id);
