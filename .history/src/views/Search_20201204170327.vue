      ...
      <div class="hotsearch">
        ...
        <div class="hotsearch-box">
          <div class="hotsearch-item">
            <div class="hotsearch-count">1</div>
            <div class="hotsearch-name">那就这样把</div>
          </div>
          <div class="hotsearch-item">
            <div class="hotsearch-count">1</div>
            <div class="hotsearch-name">那就这样把</div>
          ...
          <div class="spread-btn" @click="spread" v-if="hotsearchlist > 6">{{isSpread == false ? "点击展开" : "点击收起"}}<van-icon :name="isSpread == false ? 'arrow-down' : 'arrow-up'" /></div>
        </div>
      </div>
    </div>
  </div>
